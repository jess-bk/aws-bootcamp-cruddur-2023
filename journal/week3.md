...
create a folder name lib on the bakcend-flask directory and create a file inside cognito_jwt_token.py and add the following code
```
import time
import requests
...
Flask-AWSCognito
```
run command in cli to update the dependecies 
```
